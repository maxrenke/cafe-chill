#!/usr/bin/env python3
"""
update_powermix_art.py

Downloads the latest Powermix album art from c895.org and replaces
the APIC tag on every existing C895_Powermix_KNHC_*.mp3 file.

Also saves art locally so future downloads use it.

Usage:
    python3 update_powermix_art.py
"""
...
ART_URL = "https://www.c895.org/wp-content/uploads/2018/03/PowerMix-New-Logo-Website-Small.png"
TARGET_DIR = "/DATA/Media/Music/C895/c895_powermix"
SCRIPT_DIR = os.path.dirname(os.path.abspath(__file__))
LOCAL_ART_PATH = os.path.join(SCRIPT_DIR, "c895_powermix.png")
