...
- Encodes to 128k MP3 using parallel ffmpeg workers for speed
...
- Required packages: `requests`, `mutagen`, `rich`
...
### Update Script
- **`update_c895.sh`**: Runs all three show downloaders in sequence; skips shows already downloaded for the current week.
