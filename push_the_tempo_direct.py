...
def add_metadata(mp3_file_path, date_str, track_number=None):
    try:
        ...
        audio_file.tags.add(TALB(encoding=3, text="Push The Tempo"))  # Album
        audio_file.tags.add(TDRC(encoding=3, text=date_str))  # Date
        audio_file.tags.add(TCON(encoding=3, text="Electronic"))  # Genre
        ...
        audio_file.tags.add(COMM(encoding=3, lang='eng', desc='desc', 
                                text=f"Push The Tempo radio show recorded from C895 Radio on {date_str}."))  # Comment
